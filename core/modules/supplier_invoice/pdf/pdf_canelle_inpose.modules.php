 ...
 */
class pdf_canelle_inpose extends ModelePDFSuppliersInvoices
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "Facture Fournisseur LMDB";
		$this->description = $langs->trans('SuppliersInvoiceModelLMDB');
...

	{
		...
		// Remplissage de la LCR
			...
			//Date d'Échéance
				$pdf->writeHTMLCell(190,4, 75, 225, dol_htmlentitiesbr(dol_print_date($object->date_echeance,"day",false,$outputlangs,true)),0,1);
