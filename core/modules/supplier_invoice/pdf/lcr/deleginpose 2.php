...
<p>Soci&eacute;t&eacute; : &nbsp; &nbsp; &nbsp; &nbsp; <strong>'.$outputlangs->convToOutputCharset($object->array_options['options_deleg_client']).'</strong></p>

<p><strong>'.$outputlangs->convToOutputCharset($object->array_options['options_deleg_client_adresse']).'</strong></p>

<p><strong>'.$outputlangs->convToOutputCharset($object->array_options['options_deleg_client_cs']).'</strong></p>

<p><strong>'.$outputlangs->convToOutputCharset($object->array_options['options_deleg_client_codepostale']).' '.$outputlangs->convToOutputCharset($object->array_options['options_deleg_client_ville']).'</strong></p>

<p>Entreprise principale ou </p>
