...
/**
 *	\file       htdocs/core/modules/supplier_order/doc/pdf_deleginpose.modules.php
 *	\ingroup    fournisseur
 ...
 */
class pdf_deleginpose2 extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "Délégation LMDB v2";
		$this->description = $langs->trans('SuppliersDelegationModelLMBDv2');
		...
		if ($conf->fournisseur->dir_output.'/commande')
		{
			...
			else
			{
				...
				if ($dc4_line->dc4_object_declaration == 3) {
					$file = $dir . "/" . $objectref . " - Délégation de Paiement INPOSE - ".$outputlangs->transnoentities("dc4_acte_modificatif").".pdf";
			...
			// Page 1
				...
				include DOL_DOCUMENT_ROOT.'/custom/delegation/core/modules/supplier_order/doc/deleginpose/deleginpose2.php';
